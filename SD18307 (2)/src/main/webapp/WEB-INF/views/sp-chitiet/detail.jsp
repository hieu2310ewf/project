...
<form action="/sp-chitiet/edit" method="post">
    <div class="mb-3">
        <label class="form-lable">id</label>
        <input type="text" class="form-control" name="id" value="${objInput.id}">
    </div>
    <div class="mb-3">
        <label class="form-lable">so luong ton</label>
        <input type="text" class="form-control" name="soluongton" value="${objInput.soluongton}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="mausac"  value="${objInput.mausac.id}">
    </div>
    <div class="mb-3">
        <label class="form-lable">id spct</label>
        <input type="text" class="form-control" name="sanpham"  value="${objInput.sanpham.id}">
    </div>
    <div class="mb-3">
        <label class="form-lable">id size</label>
        <input type="text" class="form-control" name="size"  value="${objInput.size.id}">
    </div>
    <div class="mb-3">
